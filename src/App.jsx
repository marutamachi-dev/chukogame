...
export function App() {
  ...
  return <><Header onSearch={search} onNavigate={navigate}/><main><Hero onPrices={() => scrollToSection("prices")} onRanking={() => scrollToSection("ranking")}/><div className="page-shell"><PriceTable onSearch={search}/><Formula/><Ranking onOpen={open} onNavigate={navigate}/><GenreNav onNavigate={navigate}/></div><ShareBar/></main></>;
}